...
std::tuple<at::Tensor,at::Tensor,at::Tensor> batch_norm_backward_plumbing(
  ...
  VMAP_CHECK_ESCAPED(maybe_layer, "batch_norm_backward");
...
std::tuple<Tensor,Tensor,Tensor> native_group_norm_plumbing(
  ...
  auto maybe_layer = maybeCurrentDynamicLayer();
  VMAP_CHECK_ESCAPED(maybe_layer, "native_group_norm");
  int64_t cur_level = maybe_layer->layerId();
...
std::tuple<Tensor,Tensor,Tensor> native_group_norm_backward_plumbing(
  ...
  // plumbing
  auto maybe_layer = maybeCurrentDynamicLayer();
  VMAP_CHECK_ESCAPED(maybe_layer, "native_group_norm_backward");
  int64_t cur_level = maybe_layer->layerId();
...
std::tuple<at::Tensor,at::Tensor,at::Tensor> native_layer_norm_backward_plumbing(
  ...
  // plumbing
  auto maybe_layer = maybeCurrentDynamicLayer();
  VMAP_CHECK_ESCAPED(maybe_layer, "native_layer_norm_backward");
  int64_t cur_level = maybe_layer->layerId();
...
struct NativeBatchNormBackwardBatchRuleHelper {
  static std::tuple<Tensor,Tensor,Tensor> apply(
    ...
    auto maybe_layer = maybeCurrentDynamicLayer();
    VMAP_CHECK_ESCAPED(maybe_layer, "apply NativeBatchNormBackwardBatchRuleHelper");
    int64_t cur_level = maybe_layer->layerId();
...
struct CudnnBatchNormBackwardBatchRuleHelper {
  static std::tuple<Tensor,Tensor,Tensor> apply(
    ...
    auto maybe_layer = maybeCurrentDynamicLayer();
    VMAP_CHECK_ESCAPED(maybe_layer, "apply CudnnBatchNormBackwardBatchRuleHelper");
    int64_t cur_level = maybe_layer->layerId();
...
struct MiopenBatchNormBackwardBatchRuleHelper {
  static std::tuple<Tensor,Tensor,Tensor> apply(
    ...
    auto maybe_layer = maybeCurrentDynamicLayer();
    VMAP_CHECK_ESCAPED(maybe_layer, "apply MiopenBatchNormBackwardBatchRuleHelper");
    int64_t cur_level = maybe_layer->layerId();
